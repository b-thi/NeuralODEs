...
4) Lastly, I present (incomplete) code on Neural ODEs. All code for this method is in Python. I have begun work on converting over this method to R in hopes of ultimately publishing a package. My code here is what I have done thus far. Plots in the final report come from a python jupyter notebook.
