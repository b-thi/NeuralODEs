---
title: "STAT 853 - Final Project - Python Code"
...
Here, I plot the loss function using the .csv saved in the previous code chunk.
...
neuralODELoss %>% 
  ...
  geom_line(color = "steelblue2", size = 1.1) +
  theme_bw() +
